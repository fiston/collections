...
@Service("multiPushFundsTransactionHandler")
public class MultiPushFundsTransactionHandler {

	String multiPushFundsTransaction;
	@Autowired
	VisaAPIClient visaAPIClient;

	public void setupMultiPushFundsTransactionRequest() {
		...
		this.multiPushFundsTransaction = "{" 
