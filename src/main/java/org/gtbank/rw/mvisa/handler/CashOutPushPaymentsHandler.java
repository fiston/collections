...
@Service("cashOutPushPaymentsHandler")
public class CashOutPushPaymentsHandler {

	String cashOutPushPayments;
	...
	public void setupCashOutPushPaymentsRequest(String consumerAccountNumber, String agentAccountNumber, double amount) {
	...
	public void executeCashOutPushPayments(String agentAccountNumber, String consumerAccountNumber, double amount){
		...
		try {
			...
			setupCashOutPushPaymentsRequest(consumerAccountNumber, agentAccountNumber, amount);

			//And we do the post to Visa Net
			String baseUri = "visadirect/";
			String resourcePath = "mvisa/v1/merchantpushpayments";
			CloseableHttpResponse response = this.visaAPIClient.doMutualAuthRequest(baseUri + resourcePath, "M Visa Transaction Test", this.cashOutPushPayments, MethodTypes.POST, new HashMap<String, String>());
			...
			Transaction t = new Transaction(u, new Date(), cashOutPushPayments, response.toString());
